...
import { Archive, RotateCcw, Trash2, Calendar, CheckSquare, BookOpen } from 'lucide-react';
...
export default function ArchivePage() {
  ...
  const [filterType, setFilterType] = useState<'all' | 'goal' | 'note' | 'task'>('all');
        ...
        <div className="flex-1 p-8 max-w-5xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              {archivedItems.length} archived {archivedItems.length === 1 ? 'item' : 'items'}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <Card>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">Archived Goals</p>
            ...
            <Card>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">Archived Notes</p>
                  <p className="text-2xl font-bold text-foreground">
          ...
          <div className="space-y-4">
            {filteredItems.length === 0 ? (
              <Card className="text-center py-12">
                <Archive size={48} className="mx-auto text-muted-foreground mb-4 opacity-40" />
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-3 flex-wrap">
                          ...
                          <span className="text-xs text-muted-foreground">
                            Archived {item.archivedDate.toLocaleDateString('en-US', {
                              year: 'numeric',
                              month: 'short',
                              day: 'numeric',
                            })}
